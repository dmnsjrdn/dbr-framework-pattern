...
{
    public class OrderItemUpdateCommandHandler : IRequestHandler<OrderItemUpdateCommand, Result<OrderItem>>
    {
        private readonly IFrameworkPatterns<OrderItem> _patterns;

        public OrderItemUpdateCommandHandler(IFrameworkPatterns<OrderItem> patterns)
        {
            _patterns = patterns;
        }

        public async Task<Result<OrderItem>> Handle(OrderItemUpdateCommand request, CancellationToken cancellationToken)
        {
